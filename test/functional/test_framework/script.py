...
# Contract opcodes
OP_CHECKINPUTCONTRACTVERIFY = CScriptOp(0xbb)
OP_CHECKOUTPUTCONTRACTVERIFY = CScriptOp(0xbc)
...
OPCODE_NAMES.update({
    ...
    OP_CHECKINPUTCONTRACTVERIFY: 'OP_CHECKINPUTCONTRACTVERIFY',
    OP_CHECKOUTPUTCONTRACTVERIFY: 'OP_CHECKOUTPUTCONTRACTVERIFY',
